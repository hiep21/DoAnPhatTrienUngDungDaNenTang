...
import { loginApi, configAxiosWithAccessToken, saveTokenToDevice, getAccessToken } from "../services/Game";
import Background from './Background';
import { LoginData, LoginDataToken } from '../services/interfaces/GameService';
...
const LoginScreen = ({ navigation }) => {
    ...
    const loadToken = async() => {
        ...
        if(token) {
            ...
            navigation.navigate("ManagerGameScreen",{ user: users.user})
        }
    }
        ...
        <View style={styles.mainContainer}>
            ...
            <View style={styles.buttons}>
                ...
                <View style={styles.signup}>
                    ...
                    <TouchableOpacity >
                        <Text style= {styles.textSignup} onPress={() => navigation.navigate('AddUserScreen')}>Signup</Text>
                    </TouchableOpacity>
                </View>
            
            </View>
            <View>
                    <Image source={require("../assets/game.png") } style={styles.image}/>
            </View>
        </View>
